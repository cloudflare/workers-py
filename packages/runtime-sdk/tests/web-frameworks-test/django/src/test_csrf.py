...
@pytest.mark.asyncio
async def test_csrf_form_renders_token(django_app):
    response = await fetch(django_app, "/csrf/form/")
...
@pytest.mark.asyncio
async def test_post_without_csrf_rejected(django_app):
...
@pytest.mark.asyncio
async def test_csrf_exempt_allows_post(django_app):
    response = await post_json(django_app, "/csrf/exempt/", {"value": "ok"})
...
@pytest.mark.asyncio
async def test_csrf_form_token_post(django_app):
    get_response = await fetch(django_app, "/csrf/form/")
